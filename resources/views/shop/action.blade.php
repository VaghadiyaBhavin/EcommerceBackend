...
<div>
  ...
  <div class="inline"><a class="btn btn-xs btn-default text-teal" href="{{ route('shop.edit',$id) }}"><i class="fa fa-lg fa-fw fa-edit"></i></a>
...
$(document).on('change', '#customSwitch{{$id}}', function(){
  ...
  $.ajax({
      method: 'get',
      url: '{{ url('ShopchangeStatus')}}/'+status+'/'+id,
  });
});
</script>